...
namespace Box2D {
	...
	public class b2World {
		...
		public void QueryAABB(b2QueryCallback* callback, const b2AABB& aabb){
			throw new NotImplementedException();
		...
		public void RayCast(b2RayCastCallback* callback, const b2Vec2& point1, const b2Vec2& point2){
			throw new NotImplementedException();
		...
		private void DrawJoint(b2Joint* joint)void b2World::DrawJoint(b2Joint* joint)
		{
